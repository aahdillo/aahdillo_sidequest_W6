...
function preload() {
  ...
  hitEnemySfx = loadSound("assets/sfx/hitEnemy.wav");
  leafCollectSfx = loadSound("assets/sfx/leafCollect.wav");
  receiveDamageSfx = loadSound("assets/sfx/receiveDamage.wav");
...
function draw() {
  ...
  if (!music.isPlaying() && kb.presses("any")) {
    music.setLoop(true);
    music.setVolume(0.3);
    music.play();
  }
